...
void mixedStrategy(int a[CAP_ROW_SIZE][CAP_COLUMN_SIZE]) {
...
void main() {
    ...
    minimax = mini_max(num_playerB_strategy);
    printf("Minimax = %d\n", minimax.val);
    maximin = maxi_min(num_playerA_strategy);
    printf("Maximin = %d\n", maximin.val);
